...
Route::get('/', function () {
    ...
    // ciclo e creo array di tipi di pasta
    foreach ($data as $key => $el) {
        // id elemento corrispondente indice del data
        $el['id'] = $key;

        if ($el["tipo"] == "lunga") {
            $pasteLunghe[] = $el;
        } elseif ($el["tipo"] == "corta") {
            $pasteCorte[] = $el;
        } elseif ($el["tipo"] == "cortissima") {
            $pasteCortissime[] = $el;
        }
    }
